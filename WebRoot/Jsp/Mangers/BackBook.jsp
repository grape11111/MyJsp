...
<html>
  <head>
    ...
    <title>My JSP 'BackBook.jsp' starting page</title>
  ...
  <%
            ...
            String sql="Update BookBorrow SET Returndate=getdate()  Where CBno='"+cbno+"';";
            ...
            out.print("<script type='text/javascript'>alert('还书成功!');window.location.href='Jsp/Mangers/BorrowMessage.jsp';</script>");
